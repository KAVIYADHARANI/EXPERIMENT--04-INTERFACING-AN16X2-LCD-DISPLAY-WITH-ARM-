...
{
	Lcd_cursor(&lcd,0,1);
	Lcd_string(&lcd,"Name:Kaviya D\n");

	Lcd_cursor(&lcd,1,1);
	Lcd_string(&lcd,"212223040089\n");
	for(int x=0;x<100;x++)
	{
		Lcd_cursor(&lcd,2,1);
		Lcd_int(&lcd,x);
...
## Output screen shots of proteus  :
 ...
 ![WhatsApp Image 2024-09-23 at 13 58 58_3aef8331](https://github.com/user-attachments/assets/61a6d6a9-adc3-4cea-8da0-710238cba934)

 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 
 ![WhatsApp Image 2024-09-23 at 13 58 59_1f04ef28](https://github.com/user-attachments/assets/86b94baf-b482-42b4-8ef3-cbdc7b98468c)
